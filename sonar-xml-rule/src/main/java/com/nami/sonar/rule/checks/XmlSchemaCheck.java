...
import com.nami.sonar.rule.parsers.DetectSchemaParser;
import com.nami.sonar.rule.parsers.DetectSchemaParser.Doctype;
import com.nami.sonar.rule.schemas.SchemaResolver;
...
public class XmlSchemaCheck extends AbstractXmlCheck {
  ...
  @VisibleForTesting
  public static void setFeature(Validator validator, String feature, boolean value) {
    try {
