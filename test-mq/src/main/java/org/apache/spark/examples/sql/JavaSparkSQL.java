...
public class JavaSparkSQL {
	public static class Person implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 721970133801902609L;
		private String name;
		private int age;
	...
	public static void main(String[] args) throws Exception {
		...
		//加载指定的文件作为RDD（弹性分布式数据集），把内容转换成java bean
		JavaRDD<Person> people = ctx.textFile("src/main/resources/people.txt").map(new Function<String, Person>() {
			@Override
